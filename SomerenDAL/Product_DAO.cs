...
namespace SomerenDAL
{
    public class Product_DAO : Base
    {
        ...
        {
            string query = "SELECT product_id, product_name, product_price, product_vat, product_age, product_stock, product_restocklevel FROM Products";
